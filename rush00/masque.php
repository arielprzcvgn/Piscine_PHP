<?php
    ...
    $sql = "SELECT product_name, product_price FROM products WHERE category LIKE 'masque'";
            ...
            <?php
                for ($i = 0; $i != sizeof($product_list); $i++)
                {
                    ...
                    $new_prod = "<div id='" . $name . "' class='products' value='" . $price . "'>\n" .
                                "<img src='ressources/img_prod/masque/" . $name . ".jpg' alt='" . $name . "' class='products_pics'>\n" .
